...
public abstract class DynamicSpriteBatch extends SpriteBatch {
	...
	public DynamicSpriteBatch(final float pX, final float pY,
			final ITexture pTexture, final int pCapacity,
			final VertexBufferObjectManager pVertexBufferObjectManager) {
	...
	/**
	 * @return <code>true</code> to submit, if you made any changes, or
