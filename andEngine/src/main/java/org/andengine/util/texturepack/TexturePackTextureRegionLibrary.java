...
public class TexturePackTextureRegionLibrary {
	...
	public TexturePackTextureRegionLibrary(final int pInitialCapacity) {
		this.mIDMapping = new SparseArray<TexturePackTextureRegion>(
				pInitialCapacity);
		this.mSourceMapping = new HashMap<String, TexturePackTextureRegion>(
				pInitialCapacity);
	}
	...
	public void put(final TexturePackTextureRegion pTexturePackTextureRegion) {
		...
		this.mIDMapping.put(pTexturePackTextureRegion.getID(),
				pTexturePackTextureRegion);
		this.mSourceMapping.put(pTexturePackTextureRegion.getSource(),
				pTexturePackTextureRegion);
	}
	...
	private void throwOnCollision(
			final TexturePackTextureRegion pTexturePackTextureRegion)
		...
		} else if (this.mSourceMapping.get(pTexturePackTextureRegion
				.getSource()) != null) {
